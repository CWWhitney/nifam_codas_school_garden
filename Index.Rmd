...
The general concept of the food environment is expressed differently in the context of an intervention. In this figure we show that garden products and the education program of a shool garden are expected to influence the food environment and how this is expected to happen.    
...
The gardens will be existing areas on school grounds. The STEM option gardens will be designed to for teaching about nutrition and STEM (an approach to learning and development that integrates science, technology, engineering and maths) at primary and secondary schools.
...
Here we plot a summary table of the simulation results. We show the percentage of missing values as well as the mean, median and standard deviation (SD) for each output of our model simulations. 
