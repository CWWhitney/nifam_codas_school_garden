...
We express the general concept of the food environment is slightly differently when we describe it in the context of an intervention. In this figure we show that garden products and the education program of a school garden are expected to influence the food environment and how this is expected to happen.    
