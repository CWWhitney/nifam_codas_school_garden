---
title: "Should urban Hanoi school boards invest time and money in creating school gardens?"
...
The gardens will be designed for teaching about nutrition and STEM at primary and secondary schools. In the 2nd year to start garden running well. The 3rd year is when the education plan will be fully running.
...
### Impact of Reference Points in Prospect Theory

We should consider a reference point for forecasting NPV values. This can also influence decisions. If we choose a reference point at a higher NPV (like a best-case scenario), decision makers might take more risks to achieve gains above that reference point. This might be possible with a line on the plot to represent some reference.  
...
## Nonlinear Evaluation of Outcomes in Prospect Theory

This is a bit abstract, but the perceived value of NPV gains diminishes as those gains get larger. Losses are more severely felt than gains. This could lead decision makers to prioritize actions that protect against losses and ensure stability even if those actions don't maximize the overall NPV.
